...
var MyJozi = (function () {
    ...
    MyJozi.prototype = {
        ...
        loadData: function () {
            ...
            var art = L.tileLayer(tiles3.layer, {
                    id: me.mapId,
                    attribution: tiles3.attribution
                }),
                satellite = L.tileLayer(tiles5.layer, {
                    id: me.mapId,
                    attribution: tiles5.attribution
                }),
                topo = L.tileLayer(tiles4.layer, {
                    id: me.mapId,
                    attribution: tiles4.attribution
                });
        ...
        showMapAndTrack: function () {
            ...
            for (i = 0; i < points.length; ++i) {
                ...
                var m = L.marker([points[i].lat, points[i].lng], {
                        icon: dotIcon
                    })
